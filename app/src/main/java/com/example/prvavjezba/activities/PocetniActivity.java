...
import com.example.prvavjezba.adapters.StudentAdapter;
...
public class PocetniActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dodajStudenta = findViewById(R.id.btnDodajStudenta);

        RecyclerView recyclerView = findViewById(R.id.recyclerViewStudenti);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        StudentAdapter recyclerViewAdapter = new StudentAdapter();
